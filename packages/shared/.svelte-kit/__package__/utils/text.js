...
export const text = {
    ...
    duration(seconds, type = "long") {
        ...
        const parts = [];
        if (hours > 0)
            parts.push(`${hours} ${hoursText(hours, short)}`);
        if (min > 0)
            parts.push(`${min} ${minutesText(min, short)}`);
        if (parts.length === 0)
            parts.push(`${sec} ${secondsText(sec, short)}`);
        return parts.join(" ");
    },
    /**
 ...
 */
function hoursText(hours, short = false) {
    if (short)
        return "hod";
    if (hours === 1)
        return "hodina";
 ...
 * @param short When true, returns the short abbreviation.
 */
function minutesText(minutes, short = false) {
    if (short)
        return "min";
    if (minutes === 1)
        return "minuta";
 ...
 * @param short When true, returns the short abbreviation.
 */
function secondsText(seconds, short = false) {
    if (short)
        return "s";
    if (seconds === 1)
        return "sekunda";
