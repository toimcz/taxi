...
<label
  for={id}
  class="group relative border border-dashed border-slate-300 bg-slate-50 flex items-center justify-center text-center h-[280px] w-full cursor-pointer overflow-hidden rounded-xl transition-opacity hover:opacity-80"
>
  {#if imgUrl}
    <div
