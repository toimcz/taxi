...
let { size = 24, fill = "currentColor" }: Props = $props();
</script>
...
<svg
	...
	></g><g id="SVGRepo_iconCarrier"
		...
		></path><circle class="st0" cx="128.4" cy="191.9" r="31.9"></circle><path
		...
		></path><circle class="st0" cx="384.4" cy="191.9" r="31.9"></circle><path
